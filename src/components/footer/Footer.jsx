  ...
  return (
    ...
    <footer className='bg-dark'>
      <div className="container py-3 d-flex justify-content-between align-items-center">
        <p className='text-light m-0 text-uppercase'>Designed and Development by Victor Lascares 2022 &copy;</p>
        <div className='d-flex jusitify-content-between align-items-center gap-3'>
